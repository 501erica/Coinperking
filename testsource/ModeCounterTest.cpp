...
TEST(evalBorderDateTest, nextNoon)
{
    ...
    // 2021�N12��31���ɂ��Ă邯�ǈӖ��Ȃ��i�R���X�g���N�^�̈����ŕK�v�j
...
TEST(evalBorderDateTest, nextSpecialday_20220101)
{
    ...
    EXPECT_EQ(ModeCountTest.evalBorderDate(CalculateMode::SPECIAL_DAY).information.tm_year,
              2022 - 1900);
...
{
    // 2022�N1��26�� 21:55-2022�N1��26�� 23:00
...
{
    // 2022�N1��26�� 06:55-2022�N1��26�� 7:00
    bool FirstFlag2 = true;
    struct date testdate_input2;
    testdate_input2.information.tm_year = 2022 - 1900;
    testdate_input2.information.tm_mon = 1 - 1;
...
{
    // 2022�N1��23�� 23:55-2022�N1��24�� 0:00
    bool FirstFlag2 = true;
    struct date testdate_input2;
    testdate_input2.information.tm_year = 2022 - 1900;
    testdate_input2.information.tm_mon = 1 - 1;
